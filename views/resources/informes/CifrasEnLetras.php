...
/*
  ...
  A modo de ejemplo convierte "22"> en "veintidos".
  Puede convertir un numero entre una y ciento veintiseis cifras como máximo.

  Ejemplos de uso:
    CifrasEnLetras::convertirEurosEnLetras(22.34) --> "veintidos euros con treinta y cuatro centimos"
...
class CifrasEnLetras {
  ...
  public static $listaUnidades = array( // Letras de los numeros entre el 0 y el 29
  ...
  public static $listaOrdenesMillonPlural = array ( // Letras en plural de los ordenes de millon
  ...
  // ORDINALES (Wikipedia: "Nombres de los numeros en español", "Numero ordinal")
  ...
  /*
    Convierte a letras los numeros entre 0 y 29
  */
  ...
  */
  ...
  /*
    Primer millon: del cero al novecientos noventa y nueve mil noventa y nueve
  */
  ...
  /*
    Numeros enteros entre el cero y novecientos noventa y nueve mil novecientos noventa y nueve vigillones... etc, etc.
    Es decir entre el 0 y el (10^126)-1 o bien numeros entre 1 y 126 cifras.
    Las cifras por debajo del millon pueden ir en masculino o en femenino.
  */
  public static function convertirCifrasEnLetras($cifras, $genero='neutro', $separadorGruposSeisCifras=null) {
    ...
    // Comprobacion
    if ($numeroCifras == 0) return self::PREFIJO_ERROR.'No hay ningun numero';
    ...
    if ($numeroCifras > 126) return self::PREFIJO_ERROR.'El numero es demasiado grande ya que tiene más de 126 cifras';
  ...
  /*
    Expresa un numero con decimales y signo en letras acompañado del tipo de medida
    para la parte entera y la parte decimal.
    - Los caracters no numericos son ignorados.
    - Los multiplos de millon tienen la preposicion 'de' antes de la palabra.
    - El genero masculino o femenino solo puede influir en las cifras inferiores al millon.
  */
  ...
  */
  public static function convertirEurosEnLetras($euros, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($euros, $numeroDecimales,
      "euro", "euros", false, "centimo", "centimos", false);
  }
  ...
  */
  ...
  /*
    Funcion auxiliar de convertirNumeroEnLetras
