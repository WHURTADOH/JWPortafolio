...
$html .= '<p class="t-just"><b class="item">5.</b> Que analizadas las piezas procesales, no se observa que el contribuyente tenga periodos susceptibles a la prescripción de la acción de cobro.</p>';
...
$html .= '<p class="t-just"><b class="item">ARTÍCULO PRIMERO: NEGAR</b> la prescripción del impuesto predial expuesta por '.$ddep[0]->nombre.' con identificación número '.number_format($ddep[0]->fk_mTerceros,0,".",".").', propietario(a) de los predios relacionados, toda vez que actualmente no tiene periodos susceptibles a la prescripción.</p>';

$html .= '<p class="t-just"><b class="item">ARTÍCULO SEGUNDO: NOTIFICAR</b> personalmente la presente decisión al solicitante e informar que contra la presente procede recurso de reposición escrito en la diligencia de notificación personal, o dentro de los 10 días siguientes a ella, ante la secretaría de Hacienda de conformidad con el artículo 76 de la Ley 1437 de 2011.</p>';

$html .= '<p class="t-just"><b class="item">ARTÍCULO TERCERO: ORDENAR</b> a la oficina de cobro coactivo para que inicie el respectivo proceso de cobro coactivo y libre mandamiento de pago por el valor pendiente de pago al que hace referencia el artículo tercero del presente acto.</p>';

$html .= '<p class="t-just"><b class="item">ARTÍCULO CUARTO: ORDENAR</b> a la oficina de impuestos la aplicación de la presente decisión.</p>';
